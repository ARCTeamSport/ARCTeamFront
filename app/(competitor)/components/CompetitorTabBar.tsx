...
const TABS: TabConfig[] = [
    ...
    { name: 'training', label: 'Antrenman', icon: 'flame-outline', iconActive: 'flame' },
...
export default function CompetitorTabBar({ state, navigation }: BottomTabBarProps) {
                        ...
                        >
                            ...
                            >
                                <Ionicons
                                    ...
                                    size={22}
                                    color={isActive ? CompetitorTheme.accent : CompetitorTheme.textMuted}
                                />
                            </Animated.View>
                            <Text
                                style={[
...
const styles = StyleSheet.create({
    ...
    container: {
        flexDirection: 'row',
        backgroundColor: CompetitorTheme.tabBarBg,
        marginHorizontal: TAB_BAR_HORIZONTAL_PADDING,
        borderRadius: 24,
        borderWidth: 1,
        borderColor: CompetitorTheme.tabBarBorder,
        height: 64,
        alignItems: 'center',
        position: 'relative',
        overflow: 'hidden',
