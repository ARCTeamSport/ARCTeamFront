...
interface CompetitorActivityRingProps {
    progress: number; // 0–1
    size?: number;
    strokeWidth?: number;
    color?: string;
...
export default function CompetitorActivityRing({
    progress,
    size = 120,
    strokeWidth = 10,
    color = CompetitorTheme.ringStroke,
}: CompetitorActivityRingProps) {
            ...
            <View
                style={[
                    styles.ring,
                    {
                        ...
                        borderRadius: size / 2,
                        borderWidth: strokeWidth,
                        borderColor: CompetitorTheme.ringTrack,
                    },
                ]}
            />
